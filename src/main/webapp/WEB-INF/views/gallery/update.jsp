        ...
        <form name="modgalfrm" id="modgalfrm">
            ...
            <div class="form-group row">
                ...
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" id="die1" class="customcolor-control-input">
                    <label for="die1" class="customcolor-control-label"></label>
                </div>
            ...
            <div class="form-group row">
                <div class="custom-control custom-checkbox offset-2">
                    <input type="checkbox" id="die2" class="customcolor-control-input">
                    <label for="die2" class="customcolor-control-label"></label>
                </div>
                <div class="custom-file col-8 ">
            ...
            <div class="form-group row">
                <div class="custom-control custom-checkbox offset-2">
                    <input type="checkbox" id="die3" class="customcolor-control-input">
                    <label for="die3" class="customcolor-control-label"></label>
                </div>
                <div class="custom-file col-8 ">
