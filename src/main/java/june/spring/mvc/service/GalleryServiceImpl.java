...
import june.spring.mvc.dao.GalleryDAO;
import june.spring.mvc.utils.ImgUploadUtill;
...
@Autowired private ImgUploadUtill imgutil;
           ...
           // System.out.println(String.join("/", ofn));
            ...
            for(int i = 0; i < todie.length; ++i) {
                try {
                    ...
                    String two = "thumb/small" + g.getGno() + "_" + one;
